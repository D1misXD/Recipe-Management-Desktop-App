...
Built as a university project to demonstrate full-stack Java desktop development skills: **Java**,**JavaFX**,**OOP**,**CSS** and **SceneBuilder** for GUI, **MySQL** database integration, **CRUD** operations, user authentication, and personalized data handling.
